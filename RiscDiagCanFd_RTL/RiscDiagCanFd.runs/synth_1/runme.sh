...
HD_PWD='C:/Users/cosmi/RiscDiag_CanFd_Repo/RiscDiagCanFd/RiscDiagCanFd.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log RiscDiag_CanFd.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source RiscDiag_CanFd.tcl
