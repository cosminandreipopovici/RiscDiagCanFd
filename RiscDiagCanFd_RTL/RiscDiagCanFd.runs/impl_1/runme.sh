...
HD_PWD='C:/Users/cosmi/RiscDiag_CanFd_Repo/RiscDiagCanFd/RiscDiagCanFd.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log RiscDiag_CanFd.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source RiscDiag_CanFd.tcl -notrace
