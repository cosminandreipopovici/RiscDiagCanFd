...
entity register_file is
    ...
    port(
        ...
        read29_data: out std_logic_vector(DATA_WIDTH-1 downto 0);
        read30_data: out std_logic_vector(DATA_WIDTH-1 downto 0)
    );
end register_file;
...
begin
    ...
    read29_data<= registers(29);
    read30_data<= registers(30);
end behavioral;
